...
class ProfileView(TemplateView):
    ...
    def authorize(self, request):
        ...
        authorize_url = "{0}/app/main/#/oauth/authorize?client_id={1}&redirect_uri={2}" \
                        "&response_type=code&state=ajsfbjak".format(
    ...
    def get_profile_details(self, request):
        ...
        if code and error is None:
            ...
            emp_details = fyle_connection.extract_employee_details()
